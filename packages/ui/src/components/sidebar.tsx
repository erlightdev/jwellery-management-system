...
import { Separator } from "@jewellery-management-system/ui/components/separator";
import {
	Sheet,
	SheetContent,
	SheetDescription,
	SheetHeader,
	SheetTitle,
} from "@jewellery-management-system/ui/components/sheet";
import { Skeleton } from "@jewellery-management-system/ui/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from "@jewellery-management-system/ui/components/tooltip";
import { useIsMobile } from "@jewellery-management-system/ui/hooks/use-mobile";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: shadcn sidebar persists collapsed state in a small first-party cookie.
